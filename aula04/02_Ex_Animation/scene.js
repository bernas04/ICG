...
function computeFrame(time) {
    ...
    const cylinder = sceneElements.sceneGraph.getObjectByName("velho");
    const cube = sceneElements.sceneGraph.getObjectByName("cuboVelho");
    const sphere = sceneElements.sceneGraph.getObjectByName("esferaVelha");


    cylinder.rotation.x += step;
    cube.rotation.y += step;
    sphere.position.z = -0.5 + (4 * Math.abs(Math.sin(pass)));
